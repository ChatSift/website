...
export const dashboardMaxWidth =
	guildCardWidthDesktop * guildCardsPerPage + guildCardGap * (guildCardsPerPage - 1) + dashboardPadding * 2;
export const smallestDashboardWidth = guildCardWidthDesktop * 2 + guildCardGap * (2 - 1) + dashboardPadding * 2;
